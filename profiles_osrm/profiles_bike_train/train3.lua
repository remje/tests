...
access_tag_whitelist = { ["yes"] = true, ["permissive"] = true, ["designated"] = true, ["no"] = true, ["private"] = true, ["agricultural"] = true, ["forestry"] = true }
...
function way_function (way, result)
  ...
  if not ((highway and highway ~= "") or (route and route ~= "") or (bridge and bridge ~= "") or (railway and railway ~= "") or (public_transport and public_transport ~= ""))  then
    return
  end
